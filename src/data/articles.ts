...
export const articles: Article[] = [
  {
    ...
    summary: {
      ...
      ja: "食と薬は源が同じであるという哲学で、健康に良い食材의 조화로운 조리를 강조합니다.",
      ...
      fr: "La philosophie du bien-être selon laquelle la médecine et la nourriture partagent la même origine, mettant l'accent sur la cuisson harmonieuse d'ingrédients sains.",
    ...
    content: {
      ...
      zh: "药食同源是韩国的传统思想，意为“药与食同宗同源”。它蕴含着通过日常饮食来维持健康和预防疾病的养生哲学。在韩食中，不仅仅是为了填饱肚子，更强调通过和谐的烹饪来最大化食材本身的性质 and 药效。使用时令食材、均衡摄入各种山野菜 and 蔬菜，可以调节人体的气血，从而增强免疫力。代表性的小菜如凉拌桔梗（doraji-muchim）和炖莲藕（yeongeun-jorim）等，都是韩医学中常用的药材成分，这表明日常的餐桌本身就起到了守护健康的药房作用。",
      es: "Yaksik-dongwon es una filosofía tradicional coreana que establece que 'la medicina y la comida comparten el mismo origen'. Encarna el concept de bienestar de que la ingesta diaria de alimentos puede mantener la salud y prevenir enfermedades. Más allá de simplemente satisfacer el hambre, la cocina coreana enfatiza la cocción armoniosa para maximizar las propiedades terapéuticas naturales de los ingredientes. El uso de ingredientes de temporada, combinado con un consumo equilibrado de hierbas silvestres y verduras, regula la energía corporal y aumenta la inmunidad. Platos de acompañamiento representativos como la raíz de campanilla sazonada (doraji-muchim) muestran cómo la comida diaria actúa como medicina natural.",
      fr: "Le Yaksik-Dongwon (藥食同源) est une pensée traditionnelle coréenne qui stipule que « la nourriture et la médecine partagent la même origine ». Elle incarne le concept de bien-être selon lequel l'alimentation quotidienne permet de maintenir la santé et de prévenir les maladies. Dans la cuisine coréenne, il ne s'agit pas seulement de se rassasier, mais d'optimiser les propriétés thérapeutiques naturelles des ingrédients par une préparation harmonieuse. L'utilisation d'ingrédients de saison, combinée à une consommation équilibrée d'herbes sauvages de montagne et de légumes, régule le flux d'énergie corporelle et renforce l'immunité. Des plats d'accompagnement représentatifs, tels que la salade de racine de campanule assaisonnée (doraji-muchim) ou la racine de lotus braisée (yeongeun-jorim), illustrent parfaitement comment la table quotidienne sert de pharmacie naturelle pour préserver la santé.",
  ...
  },
  {
    ...
    element: {
      ko: "화 (火)", en: "Fire", ja: "火", zh: "火", es: "Fuego", fr: "Feu", ar: "النار", ru: "Огонь"
    },
    color: {
    ...
    subtitle: {
      ...
      fr: "L'harmonie de six saveurs et l'art de l'assaisonnement manuel (Sonmat)",
    ...
    summary: {
      ...
      fr: "Présente l'harmonie profonde des six saveurs : le sucré, le salé, l'acide, l'amer, le piquant et la saveur savoureuse intense (umami).",
    ...
    content: {
      ...
      ja: "六味（ろくみ）は、韓国料理の味を構成する六つの味の조화를 의미합니다. 전통적인 五가지 맛인 단맛, 짠맛, 신맛, 쓴맛, 매운맛에 한국 요리 특유의 깊은 맛(旨味)을 더한 개념입니다. 한국 요りは한 가지 강렬한 맛에 치우치기보다, 이 여섯 가지 맛이 입안에서 복합적으로 어우러지는 완벽한 균형을 지향합니다. 고추장과 고춧가루의 매콤함, 간장과 된장의 짭조름한 깊은 맛, 식초와 매실청의 새콤함이 상호보완적으로 작용하여 소화를 돕고 입맛을 돋웁니다. 이러한 맛의 시너지는 갈치조림이나 제육볶음 같은 대표적인 반찬에서 훌륭하게 발현됩니다.",
      ...
      fr: "Le Yukmi (六味) désigne l'harmonie des six saveurs fondamentales de la gastronomie coréenne. C'est un concept qui ajoute à la palette des cinq saveurs traditionnelles — le sucré (甘), le salé (鹹), l'acide (酸), l'amer (苦) et le piquant (辛) — le goût savoureux et profond caractéristique des aliments fermentés coréens (淡 ou 鮮). La cuisine coréenne ne cherche pas à privilégier une unique saveur intense, mais vise un équilibre complexe de ces six saveurs en bouche. Le piquant du gochujang et du gochugaru, la profondeur salée de la sauce soja et du doenjang, et la fraîcheur acide du vinaigre et du sirop de prune s'associent pour faciliter la digestion et stimuler l'appétit. Cette synergie gustative s'exprime avec excellence dans des plats populaires comme les tranches de porc sautées épicées (jeyuk-bokkeum).",
  ...
  },
  {
    ...
    subtitle: {
      ...
      fr: "L'équilibre nutritionnel et le bien-être par les cinq couleurs traditionnelles",
    ...
    summary: {
      ...
      ja: "青、赤、黄、白、黒의 五가지 색으로 조화롭고 건강한 영양 균형을 추구합니다.",
      ...
      fr: "Recherche un équilibre nutritionnel harmonieux à travers les cinq couleurs cardinales : le bleu (vert), le rouge, le jaune, le blanc et le noir.",
    ...
    content: {
      ...
      ja: "五方色（ごほうしょく）は、陰陽五行説に基づく青・赤・黄・白・黒の五つの方位の色を指します。韓国料理はこの五つの色の食材を食卓の上に調和させることで、視覚的な美しさだけでなく、栄養学的な完全성을 동시에 추구합니다. 녹색 채소의 엽록소, 적고추의 캡사이신, 계란 노른자나 단호박의 카로티노이드, 하얀 쌀밥과 무의 알리신, 검은 버섯과 김의 안토시아닌 등은 현대 영양학에서 말하는 피토케미컬(Phytochemical)의 균형과 정확히 일치합니다. 비빔밥이나 잡채와 같은 요리는 오방색 철학이 시각, 미각, 영양을 완벽하게 일체화시킨 진수입니다.",
      ...
      fr: "L'Obangsaek (五方色) désigne les cinq couleurs cardinales — le bleu (vert), le rouge, le jaune, le blanc et le noir — issues de la philosophie traditionnelle du Yin et du Yang et des Cinq Éléments. En disposant harmonieusement des ingrédients de ces cinq couleurs sur la table, la cuisine coréenne vise à la fois l'esthétique visuelle et la complétude nutritionnelle. La chlorophylle des légumes verts, la capsaïcine des piments rouges, les caroténoïdes du jaune d'œuf ou de la courge, l'allicine du riz blanc et du radis, ainsi que l'anthocyanine des champignons noirs et des algues coïncident parfaitement avec le concept moderne de l'équilibre des phytonutriments. Les plats tels que le bibimbap ou le japchae incarnent l'essence même de cette philosophie, fusionnant le plaisir des yeux, le goût et l'équilibre nutritionnel.",
  ...
  },
  {
    ...
    subtitle: {
      ...
      fr: "La culture chaleureuse du partage et de l'affection (Jeong) à travers le banchan",
    ...
    summary: {
      ...
      fr: "Explore la culture du partage de la nourriture et de la chaleur humaine (Jeong) avec ses voisins dans un esprit de convivialité.",
    ...
    content: {
      ...
      fr: "Le Nanum (Partage) reflète les valeurs d'hospitalité et de bienveillance de la communauté de table coréenne. Dans la culture culinaire de la péninsule, le banchan n'est pas conçu comme un repas individuel, mais comme une nourriture partagée (Shared dining). Cette philosophie de vie trouve sa source dans les coutumes de partage du riz avec ses voisins, la fabrication collective du Kimjang pour redistribuer le kimchi, et l'expression sincère de l'affection (Jeong). Présenter divers banchans au centre de la table, où chacun partage ses couverts, renforce les liens communautaires et cultive le respect mutuel. Cette hospitalité chaleureuse est un héritage culturel unique qui accueille à bras ouverts chaque convive autour de la table coréenne.",
  ...
  },
  {
    ...
    colorHex: "#1C1C1C",
    direction: {
      ko: "북쪽 (North)", en: "North", ja: "北", zh: "北", es: "Norte", fr: "Nord", ar: "الشمال", ru: "Север"
    },
    element: {
    ...
    title: {
      ...
      fr: "Ingrédients & Terroir : Fermentation",
    ...
    subtitle: {
      ...
      fr: "Le temps de la fermentation façonné par le climat de la péninsule et le cycle des saisons",
    ...
    summary: {
      ...
      ja: "四季と三面の海が生み出した新鮮さと発酵技術의 깊은 과학을 소개합니다.",
      ...
      fr: "Présente la fraîcheur des produits issus des saisons et des côtes de la péninsule, ainsi que la science de la fermentation.",
    ...
    content: {
      ...
      es: "Los ingredientes y el terroir enfatizan la fuerza única de los ingredientes formados por la geografía y el clima de Corea. Rodeada por mar en tres lados, caracterizada por terrenos montañosos y cuatro estaciones distintas, Corea cosecha diversos pescados y mariscos de temporada, hierbas silvestres y cultivos. Para sobrevivir a los inviernos fríos, los coreanos perfected la fermentación (kimchi, doenjang), forming la piedra angular de los sabores coreanos. Este terroir combina climas locales con ingredientes, finalizando la profunda originalidad coreana.",
      fr: "Les Ingrédients et le Terroir représentent la force des matières premières façonnées par l'environnement géographique et le climat de la Corée. La péninsule, entourée par la mer sur trois côtés, caractérisée par des régions montagneuses et quatre saisons très marquées, offre chaque saison une grande variété de fruits de mer, d'herbes sauvages et de légumes frais. Les techniques de fermentation (Fermentation), développées pour surmonter les hivers longs et rigoureux (kimchi, sauce soja, doenjang, gochujang), constituent le pilier de la profondeur gustative de la cuisine coréenne. Ces caractéristiques géographiques et climatiques s'allient pour donner vie à des produits locaux et des méthodes de préparation uniques. La maturation lente par la nature et le temps, conjuguée à la fraîcheur des ingrédients, complète l'identité authentique et sainte du K-Food.",
