...
export const articles: Article[] = [
  {
    ...
    summary: {
      ...
      ja: "食と薬は源が同じであるという哲学のもと、健康에 좋은 식재료의 조화로운 조리를 강조합니다...",
    ...
    content: {
      ...
      ja: "薬食同源（やくしょくどうげん）は、「食と薬は源が同じである」という韓国の伝統思想です。これは普段食べる食事を通じて健康を維持し、病気を予防できるというウェルネスの哲学을 반영합니다. 한국 요리에서는 단순히 배를 채우는 것을 넘어, 식재료가 가진 성질과 약효를 극대화할 수 있는 조화로운 조리를 강조합니다. 제철 식재료의 사용, 다양한 산나물과 채소류의 균형 잡힌 섭취는 우리 몸의 기운을 다스려 면역력을 증진시킵니다. 대표적인 반찬인 도라지무침이나 연근조림 등은 한의학에서도 약재로 쓰이는 식재료들로, 일상적인 식탁 자체가 곧 건강을 지키는 약방 역할을 함을 보여줍니다.",
      ...
      zh: "药食同源是韩国的传统思想，意为“药与食同宗同源”。它蕴含着通过日常饮食来维持健康和预防疾病的养生哲学。在韩食中，不仅仅是为了填饱肚子，更强调通过和谐的烹饪来最大化食材本身的性质 and 药效。使用时令食材、均衡摄入各种山野菜 and 蔬菜，可以调节人体的气血，从而增强免疫力。代表性的小菜如凉拌桔梗（doraji-muchim）和炖莲藕（yeongeun-jorim）等，都是韩医学中常用的药材成分，这表明日常의 餐桌 자체가 건강을 지키는 약방 역할을 함을 보여줍니다.",
  ...
  },
  {
    ...
    content: {
      ...
      ja: "六味（ろくみ）は、韓国料理の味を構成する六つの味の調和を意味します。伝統的な五つの味である甘味（甘）、塩味（鹹）、酸味（酸）、苦味（苦）、辛味（辛）に、韓国料理特有の深い旨味（淡または鮮）を加えた概念です。韓国料理は単一の強烈な味に偏るのではなく、これら六つの味が口の中で複合的に調和する完璧なバランスを目指します。コチュジャンや粉唐辛子のピリッとした辛さ、醤油や味噌の塩気のある深い味わい、酢や梅エキスの酸味が相互補完的に働き、消化を助け食欲をそそります。このような味のシナジーは、太刀魚の煮付け（カルチジョリム）や豚肉炒め（ジェユкポックム）などの代表的なおかずで素晴らしく発揮されます。",
      ja: "六味（ろくみ）は、韓国料理の味を構成する六つの味の調和を意味します。伝統的な五つの味である甘味（甘）、塩味（鹹）、酸味（酸）、苦味（苦）、辛味（辛）に、韓国料理特有の深い旨味（淡または鮮）を加えた概念です。韓国料理は単一の強烈な味に偏るのではなく、これら六つの味が口の中で複合的に調和する完璧なバランスを目指します。コチュジャンや粉唐辛子のピリッとした辛さ、醤油や味噌の塩気のある深い味わい、酢や梅エキスの酸味が相互補完的に働き、消化を助け食欲をそそります。このような味のシナジーは、太刀魚の煮付け（カルチジョリム）や豚肉炒め（ジェユクポックム）などの代表的なおかずで素晴らしく発揮されます。",
  ...
  },
  {
    ...
    content: {
      ...
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮の文化です。韓国料理においておかず（バンチャン）は、個인의 食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチを分け合い、情（ジョン）を表現する風習は、分かち合いの価値観から生じています。食卓の中央に多様なおかずを置き、みんなでスプーンや箸を共有しながら食事をする構造は、共同体の結びつきを強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国の食卓를...가 아니라",
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮の文化です。韓国料理においておかず（バンチャン）は、個人の食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチを分け合い、情（ジョン）を表現する風習は、分かち合い의 価値観から生じています。食卓の中央に多様なおかずを置き、みんなでスプーンや箸を共有しながら食事をする構造は、共同体の結びつきを強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国の食卓を囲むすべての人に温かい情を感じさせるユニークな食文化の資産です。",
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮の文化です。韓国料理においておかず（バンチャン）は、個人の食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチを分け合い、情（ジョン）を表現する風習は、分かち合いの価値観から生じています。食卓の中央に多様なおかずを置き、みんなでスプーンや箸を共有しながら食事をする構造は、共同体の結びつきを強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国の食卓를...가 아니라",
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮の文化です。韓国料理においておかず（バンチャン）は、個人の食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチを分け合い、情（ジョン）を表現する風習は、分かち合いの価値観から生じています。食卓の中央に多様なおかずを置き、みんなでスプーンや箸を共有しながら食事をする構造は、共同体の結びつきを強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国의 食卓を囲むすべての人に温かい情を感じさせるユニークな食文化の資産です。",
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮의 文化입니다. 韓国料理においておかず（バンチャン）は、個人の食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチを分け合い、情（ジョン）を表現する風習は、分かち合いの価値観から生じています。食卓の中央に多様なおかずを置き、みんなでスプーンや箸を共有しながら食事をする構造は、共同体の結びつきを強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国の食卓を囲むすべての人に温かい情を感じさせるユニークな食文化の資産です。",
      ja: "分かち合い（ナヌム）は、韓国의 食事共同体가...가 아니라",
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮の文化です。韓国料理においておかず（バンチャン）は、個人の食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチを分け合い、情（ジョン）を表現する風習は、分かち合いの価値観から生じています。食卓の中央に多様なおかずを置き、みんなでスプーンや箸を共有しながら食事をする構造は、共同体の結びつきを強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国の食卓를 囲むすべての人に温かい情を感じさせるユニークな食文化の資産です。",
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮の文化です。韓国料理においておかず（バンチャン）は、個人の食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチ를...가 아니라",
      ja: "分かち合い（ナヌム）は、韓国の食事共同体が持つ歓待と配慮の文化です。韓国料理においておかず（バンチャン）は、個人の食事を超えて、みんなで共有して食べるシェアダイニング（Shared dining）の性格を持ちます。隣人とご飯を分かち合い、キムジャン（キムチ漬け）をして村全体でキムチを分け合い、情（ジョン）を表現する風習は、分かち合いの価値観から生じています。食卓の中央に多様なおかずを置き、みんなでスプーンや箸を共有しながら食事をする構造は、共同体の結びつきを強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国の食卓を囲むすべての人に温かい情を感じさせるユニークな食文化の資産です。",
  ...
  },
  {
    ...
    content: {
      ...
      ja: "食材と風土（Ingredients & Terroir）は、韓国の地理的環境と気候が生み出した独創的な食材の力です。三方を海に囲まれた半島地形と山がちな地理的特徴, 四季가...가 아니라",
      ja: "食材と風土（Ingredients & Terroir）は、韓国の地理적 환경과 기후가 빚어낸... 가 아니라",
      ja: "食材と風土（Ingredients & Terroir）は、韓国の地理적 환경과 기후가 빚어낸...가 아니라",
