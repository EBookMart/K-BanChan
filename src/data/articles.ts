...
export const articles: Article[] = [
  {
    ...
    gradientClass: "from-blue-600 to-teal-500",
    ...
    color: {
      ko: "청색 (Blue)", en: "Blue", ja: "青", zh: "青", es: "Azul", ar: "الأزرق", ru: "Синий"
    },
    title: {
      ko: "약식동원 (藥食同源)",
      en: "Yaksik-dongwon: Food as Medicine",
      ja: "薬食同源 (やくしょくどうげん)",
      zh: "药食同源 (Yaksik-dongwon)",
      es: "Yaksik-dongwon: Medicina y Comida",
      ar: "ياكسيك دونغوون: الغذاء كدواء",
      ru: "Якшик-донвон: Еда как лекарство"
    },
    summary: {
    ...
    content: {
      ...
      ja: "薬食同源（やくしょくどうげん）は、「食と薬は源が同じである」という韓国の伝統思想です。これは日頃口にする食べ物を通じて健康を維持し、病気を予防できるというウェルネスの哲学を反映しています。韓国料理では単にお腹を満たすだけでなく、食材が持つ性質や薬効を極大化できる調和のとれた調理を強調します。旬の食材の使用や山菜・野菜類のバランスの取れた摂取は、体内のエネルギーを整え免疫力を高めます。代表的なおかずであるトラジ（キキョウの根）の和え物やレンコンの煮物などは、漢方でも薬材として使われる食材であり、日常の食卓自体が健康を守る薬局の役割を果たしていることを示しています。",
      zh: "药食同源是韩国的传统思想，意为“药与食同宗同源”。它蕴含着通过日常饮食来维持健康和预防疾病的养生哲学。在韩食中，不仅仅是为了填饱肚子，更强调通过和谐的烹饪来最大化食材本身的性质和药效。使用时令食材、均衡摄入各种山野菜和蔬菜，可以调节人体的气血，从而增强免疫力。代表性的小菜如凉拌桔梗（doraji-muchim）和炖莲藕（yeongeun-jorim）等，都是韩医学中常用的药材成分，这表明日常的餐桌本身就起到了守护健康的药房作用。",
  ...
  },
  {
    ...
    content: {
      ...
      ja: "六味（ろくみ）は、韓国料理の味を構成する六つの味の調和を意味します。伝統的な五つの味である甘味、塩味、酸味、苦味、辛味に、韓国料理特有の深い「旨味」を加えた概念です。韓国料理は一つの強烈な味に偏るのではなく、これら六つの味が口の中で複雑に調和する完璧なバランスを目指します。コチュジャンや粉唐辛子の辛さ、醤油や味噌の塩気と深いコク、酢や梅エキスの酸味が補完し合って消化を助け、食欲をそそります。この味のシナジーは、カルチジョリム（太刀魚の煮付け）やジェユクボックム（豚肉の辛炒め）などの代表的なおかずで素晴らしく表現されています。",
  ...
  },
  {
    ...
    content: {
      ...
      ja: "五方色（ごほうしょく）は、陰陽五行説に基づく青・赤・黄・白・黒の五つの方位の色を指します。韓国料理はこの五つの色の食材を食卓の上に調和させることで、視覚的な美しさだけでなく、栄養学的な完全性を同時に追求します。緑色野菜のクロロフィル、赤唐辛子のカプサイシン、卵黄やカボチャのカロテノイド、白いご飯や大根のアリシン、黒いキノコや海苔のアントシアニンなどは、現代栄養学におけるフィトケミカル（植物化学物質）のバランスと正確に一致します。クジョルパン（九折坂）やビビンバ、チャプチェのような料理は、五方色の哲学が視覚、味覚、栄養を完璧に一体化させた真髄です。",
      zh: "五方色是指基于阴阳五行学说的青、赤、黄、白、黑五种方位的颜色。韩食将这五种颜色的食材和谐地呈现在餐桌上，既追求视觉上的美感，又同时追求营养学上的完整性。绿色蔬菜的叶绿素、红辣椒的辣椒素、蛋黄和南瓜的类胡萝卜素、白米饭和白萝卜的大蒜素、黑木耳和海苔的花青素等，与现代营养学所说的植物化学素（Phytochemical）平衡完全一致。九折坂、石锅拌饭和杂菜等料理，是五方色哲学将视觉、味觉和营养融为完美一体的精髓。",
  ...
  },
  {
    ...
    summary: {
      ...
      ja: "情（チョン）とおかずを隣人と豊かに分かち合って食べる相生と歓待の食文化を扱います。",
    ...
    content: {
      ...
      ja: "分かち合い（Nanum）は、韓国の食卓共同体が持つ歓待と配慮の文化です。韓国料理においておかず（Banchan）は、一人分のお膳を超えて、皆で共有して食べるシェア飯（Shared dining）の性格を持ちます。隣人とご飯を分け合い、キムジャン（キムチ漬け）をして村中でキムチを分け合い、情（チョン）を表現する風習は、この分かち合いの価値観に基づいています。食卓の中央に多様なおかずを置き、皆でスプーンや箸を交えながら食事をする構造は、共同体の絆を強め、お互いを尊重する心を育てます。このような歓待と配慮の精神は、韓国の食卓を囲むすべての人に温かい情を感じさせるユニークな食文化の資産です。",
  ...
  },
  {
    ...
    content: {
      ...
      ja: "食材と風土（Ingredients & Terroir）は、韓国の地理的環境と気候が生み出した独創的な食材の力です。三方を海に囲まれた半島地形と山地が多い地理的特性、四季がはっきりした気候は、季節ごとに多様な旬の海産物や野生の山菜、野菜をもたらします。寒く長い冬に備えるために発達したキムチ、醤油、味噌、コチュジャンなどの「発酵」技術は、韓国料理の深い味わいを支える礎石です。このような風土的特性は各地域の気候と結びつき、固有のローカル食材と調理技術を誕生させました。時間と自然がゆっくりと醸し出した天然の調味料と食材の新鮮さが融合し、韓国料理ならではの深みのある健康的なオリジナリティを完成させます。",
