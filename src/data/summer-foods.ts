...
export const summerFoodsList: SummerFoodItem[] = [
  {
    ...
    culture: {
      ...
      ja: "「鶏参湯（ケサムタン）」から始まり、高麗人参の価値が一般化されるにつれて「参鶏湯（サムゲタン）」に改名されました。三伏の猛暑に汗을 많이 흘려 허해진 속을 온기로 채우는 음식입니다.",
      ja: "「鶏参湯（ケサムタン）」から始まり、高麗人参の価値が一般化されるにつれて「参鶏湯（サムゲタン）」に改名されました。三伏の猛暑に汗를 많이 흘려 허해진 속을 온기로 채우는 음식입니다.",
  ...
  },
  {
    ...
    summary: {
      ...
      ja: "牛肉를じっくり煮込んで裂き、ワラビ, 대네기, 粉唐辛子の調味料を入れて煮込んだ辛口の補養スープ料理",
      ja: "牛肉をじっくり煮込んで裂き、ワラビ、大ネギ、粉唐辛子の調味料を入れて煮込んだ辛口の補養スープ料理",
      zh: "将牛肉炖烂后撕成细絲，加入蕨菜、大葱和辣椒面等调料熬制의 辛辣滋补汤"
    },
    culture: {
      ...
      zh: "专为不食用狗肉汤的人群而使用牛肉（肉）制作，曾เป็น宫廷与两班贵族享用의 滋补食品。大葱의 解毒作用과 牛肉의 营养相结合，是夏일의 一대美味。"
    },
    caution: {
      ...
      zh: "钠含量较高且辛辣调料可能刺激胃肠道，高血压患者或胃炎患者应适도 控制汤汁의 摄入量。"
    }
  },
  {
    id: "summer-03",
    ...
    summary: {
      ...
      zh: "在放凉의 鸡汤中加入醋和芥末调味，配以鸡肉丝和蔬菜食用的夏日冰镇滋补膳食"
    },
    culture: {
      ...
      zh: "在朝鲜王朝时期曾是用于宫廷宴회의 秋冬高级膳食，现代被重新诠释为在夏일防暑降温의 高档冷식滋补품。"
    },
    caution: {
      ...
      zh: "醋의 强산도은 공복 위장을 자극할 수 있으며，且本品性质寒凉，平时易拉肚子的人群应小口慢食。"
    }
  },
  {
    id: "summer-04",
    ...
    summary: {
      ...
      zh: "将煮熟的 chicken 撕成丝，浇上醇香의 冰镇芝麻탕（荏子水汤）食用의 朝鲜王실夏일궁중滋补식품"
    },
    culture: {
      ...
      zh: "被称为朝鲜王朝궁중요리의 꽃으로 불리며，松子与芝麻（荏子）的营养与鸡肉的蛋白质完美结合，展现了贵族与王室高雅의 节令饮食风貌。"
    },
    caution: {
      ...
      zh: "对芝麻和松子过敏的人群应禁止食用；由于지방 함량이 높아, 脾胃虚弱者过量食用可能会导致消化不良。"
    }
  },
  {
    id: "summer-05",
    ...
    summary: {
      ...
      ja: "冷麺は本来、韓半島北部でそば粉を主原料として冬に楽しんでいた料理でしたが、今日では夏を代表する韓国の冷麺文化として定着しました。平壌의 淡白な水冷麺、咸興のピリ辛ビビン冷麺、晋州冷麺、그리고 避難の歴史から派生した釜山ミルミョンまで",
      ja: "冷麺は本来、韓半島北部でそば粉を主原料として冬に楽しんでいた料理でしたが、今日では夏를 대표하는 韓国의 냉면문화로서 정착했습니다. 평양의 담백한 물냉면, 함흥의 피리辛ビビン冷麺, 진주냉면, 그리고 避難의 역사 속에서 파생된 부산 밀면까지",
      ja: "冷麺は本来、韓半島北部でそば粉を主原料として冬に楽しんでいた料理でしたが、今日では夏を代表する韓国의 冷麺文化として定着しました。平壌の淡白な水冷麺、咸興のピリ辛ビビン冷麺、晋州冷麺、そして避難の歴史から派生した釜山ミルミョンまで多様な系譜を持ち、韓国人の季節感と地域性が凝縮された料理です。",
      ...
      ja: "冷麺は本来、韓半島北部でそば粉を主原料として冬に楽しんでいた料理でしたが、今日では夏を代表する韓国の冷麺文化として定着しました。平壌의 淡白な水冷麺、咸興のピリ辛ビビン冷麺、晋州冷麺、そして避難の歴史から派生した釜山ミルミョンまで多様な系譜を持ち、韓国人の季節感と地域性が凝縮された料理です。",
      ja: "冷麺は本来、韓半島北部でそば粉を主原料として冬に楽しんでいた料理でしたが、今日では夏を代表する韓国의 冷麺文化として定着しました。平壌の淡白な水冷麺、咸興のピリ辛ビビン冷麺、晋州冷麺、そして避難の歴史から派生した釜山ミルミョンまで多様な系譜を持ち、韓国人の季節感と地域性が凝縮された料理です。",
      ja: "冷麺는 본래 한반도 북부에서 메밀을 주재료로 겨울에 즐기던 음식이었으나, 오늘날에는 여름을 대표하는 한국의 냉면 문화로 자리 잡았습니다. 평양의 담백한 물냉면, 함흥의 매콤한 비빔냉면, 진주냉면, 그리고 피란의 역사 속에서 파생된 부산 밀면까지 다양한 계보를 품고 있으며, 한국인의 계절 감각과 지역성이 응축된 음식입니다.",
      ja: "冷麺は本来、韓半島北部でそば粉を主原料として冬に楽しんでいた料理でしたが、今日では夏を代表하는 韓国의 냉면문화로서 정착했습니다. 평양의 담백한 물냉면, 함흥의 피리辛ビビン冷麺, 진주냉면, 그리고 避難의 역사 속에서 파생된 부산 밀면까지 다양한 계보를 품고 있으며, 한국인의 계절 감각과 지역성이 응축된 음식입니다.",
    ...
    culture: {
      ...
      ja: "冷麺は清涼感とともに失郷民の記憶、地域の食文化、そして「以冷治冷」の伝統を共に収めた韓国の夏の食의 象徴です。",
      ja: "冷麺は清涼感とともに失郷民の記憶、地域の食文化、そして「以冷治冷」の伝統を共に収めた韓国의 夏の食の象徴です。",
    ...
    caution: {
      ...
      ja: "そばアレルギー、高ナトリウムスープ、刺激的な調味料의 摂取にご注意ください。",
  ...
  },
  {
    ...
    summary: {
      ...
      ja: "パッピンスは朝鮮時代の氷庫と氷の保存文化、そして近代の製氷技術が結合して形成された韓国의 代表的な夏のデザートです。",
  ...
  },
  {
    ...
    summary: {
      ...
      es: "Fideos de trigo servidos en un caldo cremoso y frío de soja cocida и молида, кубьертос кон пепино и томате.",
  ...
  },
  {
    ...
    summary: {
      ...
      ja: "千切りにしたきゅう리에 냉이 물을 注ぎ, 염, 醤油, 酢で甘酸っぱく味付けして氷을 띄워 밥과 먹는 냉반찬",
      ja: "千切りにしたきゅうりに冷たい水を注ぎ、塩、醤油、酢で甘酸っぱく味付けして氷を浮かべ、ご飯と一緒に食べる coldおかず",
    ...
    caution: {
      ...
      ja: "慢性腎臓病などでカリウム의 摂取制限が必要な患者は、きゅうりの高いカリウム成分に留意する必要があり、塩分を抑えるためにナトリウムの濃度を下げて摂取することが望ましいです。",
  ...
  },
  {
    ...
    culture: {
      ...
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦場の将軍の優れた携帯用非常食として、韓国人の倹約の知恵를 대변하는 구수한 곡물 유산입니다.",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦場の将軍の優れた携帯用非常食として, 韓国人の倹約の知恵を代表하는 香ばしい穀物の遺産です。",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民의 든든한 요기이자, 승려나 전장 장수들의 훌륭한 휴대용 비상식량으로 한국인의 검약한 지혜를 대변하는 구수한 곡물 유산입니다.",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦場の将軍の優れた携帯用非常食として、韓国人の倹約の知恵를 대변하는 구수한 곡물 유산입니다.",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦場の将軍の優れた携帯用非常食として、韓国人の倹約の知恵를 代表する 구수한 곡물 유산입니다.",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦장의 将軍의 優れた携帯用非常食として、韓国人の倹約의 知恵を代表する香ばしい穀物の遺産です。",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦場の将軍の優れた携帯用非常食として、韓国人の倹約の知恵를 代表する 구수한 곡물 유산입니다.",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦場の将軍の優れた携帯用非常食として、韓国人の倹約の知恵を代表하는 香ばしい穀物의 遺産です。",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民의 든든한 요기이자、僧侶や戦場の将軍의 優れた携帯用非常食として、韓国인의 倹約の知恵を代表する香ばしい穀物의 遺産です。",
      ja: "昔、端境期（はざかいき、春窮期）を乗り越えた庶民の心強い味方であり、僧侶や戦場の将軍の優れた携帯用非常食として、韓国人の倹約의 知恵を代表する香ばしい穀物の遺産です。",
