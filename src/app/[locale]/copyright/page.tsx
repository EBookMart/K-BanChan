...
export default function CopyrightPage() {
  const t = useTranslations("copyright_page");

  // 6개 섹션 정보를 새롭게 업데이트된 다국어 번역 키를 바탕으로 구성합니다.
  const sections = [
    { title: t("owner_section"), content: t("owner_section_desc") },
    { title: t("protected_content"), content: t("protected_content_desc") },
    { title: t("permitted_use"), content: t("permitted_use_desc") },
    { title: t("prohibited_use"), content: t("prohibited_use_desc") },
    { title: t("report"), content: t("report_desc") },
    { title: t("dmca"), content: t("dmca_desc") },
  ];
